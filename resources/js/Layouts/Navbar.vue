<template lang="">
    <div class="sticky pt-3 bg-gradient-to-r from-emerald-700 to-green-600">
        <div class="grid grid-cols-2">
            ...
            <div
                class="flex items-center justify-end mr-2 space-x-1 place-self-end"
            >
                <img
                    src="images/logoalfa2.png"
                    alt="logo"
